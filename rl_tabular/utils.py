# An implementation of OrderedSet from
# https://github.com/LuminosoInsight/ordered-set/blob/master/ordered_set.py
# available under the MIT license; added a dict-like get method; added
# bytes as an atomic type.
...
def _is_atomic(obj: Any) -> bool:
    ...
    character.
    """
    return isinstance(obj, str) or isinstance(obj, tuple) or isinstance(obj, bytes)
...
class OrderedSet(MutableSet[T], Sequence[T]):
    ...
    def get(self, key: T, default: Optional[int] = None) -> int:
        """
        Get the index of a given entry and return default if they key is
        not present.
        `key` needs to be a single key, not an iterable.
        """
